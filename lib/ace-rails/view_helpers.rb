  ...
  module Rails
    module ViewHelpers
        ...
        def ace_editor(options = {})
          ...
          theme_script_tag = theme ? "<script type='text/javascript' src='/assets/ace/theme-#{theme}.js' charset='utf-8' ></script>" : ""
...
<script type='text/javascript' src='/assets/ace/mode-#{mode}.js' charset='utf-8' ></script>
#{theme_script_tag}
